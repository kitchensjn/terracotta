...
def track_lineage_over_time(
    ...
    for element, node_combo in enumerate(pc_combos):
        if node_combo[0] == node_combo[1]:
            ...
            outgoing_child_message = _calc_branch_message(child_pos, bl_child, transition_matrices, direction="backward")
            outgoing_parent_message = _calc_branch_message(parent_pos, bl_parent, transition_matrices, direction="forward")
