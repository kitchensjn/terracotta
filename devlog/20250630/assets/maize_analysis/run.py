...
trees = [ts for ts in glob(f"trees/*")]

for t_string in trees[8:9]:

    iso_tree = [tct.nx_bin_ts(tskit.load(t_string).simplify(), [0, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000, 100000000000]).first()]

    cl = []
    bal = []
    r = []
    for tree in iso_tree:
